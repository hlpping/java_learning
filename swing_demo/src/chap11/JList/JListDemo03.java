...
class MyListModel03 extends AbstractListModel{
...
class MyList03 implements ListSelectionListener{
	...
	public MyList03(){
		...
		v.add("MLDNJAVA") ;
		v.add("智囊团") ;
		this.list1 = new JList(new MyListModel03()) ;

...
public class ReflectTest {
	...
	public void testGetClass() throws Exception{
		 // 1.根据类名获取class对象
		Class clazz =Class.forName("day30_reflect.Person");
...
class Person {
	...
	public void fun() {
		System.out.println("这是Person类无参的fun方法, 当前对象的name是: " + name + ", age是: " + age);
	}

	public void fun(int i) {
		System.out.println("这是Person类有一个int参数的fun方法, 当前对象的name是: " + name + ", age是: " + age + ", int参数是: " + i);
	}
